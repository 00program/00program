let DRAIN_COUNT = 512;
const AUTO_RETRY_DELAY_MS = 80;         // +30ms para dar margen al GC
const CAPTURE_DELAY_MS = 80;            // +30ms
const COMPOSE_DELAY_MS = 150;           // +50ms
...
const IDENT_OFFSET = 0x30;                  // movido para más espacio
...
const identityBytes = new Uint8Array(16);   // ampliado
