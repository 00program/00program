...
(async function () {
    ...
    try {
        ...
        // Aumentar iteraciones y spray
        const ITERS = params.has("iters") ? parseInt(params.get("iters"), 10) : 600; // antes 400
        const SPRAY_NUM = params.has("spray") ? parseInt(params.get("spray"), 10) : 0x300; // antes 0x200
        ...
        const PRE_SUSPEND_MS = params.has("presleep")
            ? parseInt(params.get("presleep"), 10) : 20; // antes 15
        ...
        const ATTEMPTS = params.has("attempts")
            ? parseInt(params.get("attempts"), 10) : 30; // antes 20
